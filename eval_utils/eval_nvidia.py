...
def eval_nvidia_dir(gt_dir, pred_dir, report_dir, fixed_view_id=0):
    ...
    for time in range(time_start, time_end):  # Fix view v0, change time
        ...
        img_true = cv2.imread(gt_fn) # H,W,3
        img = cv2.imread(pred_fn) # H,W,3

        _psnr = cv2.PSNR(img_true, img)
        # _ssim = structural_similarity(img_true, img, multichannel=True)
        _ssim = structural_similarity(img_true, img, channel_axis=-1, data_range=255)
    ...
    with open(osp.join(report_dir, "nvidia_render_metrics.txt"), "w") as f: # '/home/xuankai/code/MoSca/data/nvidia/Balloon1/logs/nvidia_fit_native_add3_20250426_200613/tto_test_report/nvidia_render_metrics.txt'
    ...
    save_report_fn = osp.join(report_dir, "nvidia_render_metrics.xlsx") # '/home/xuankai/code/MoSca/data/nvidia/Balloon1/logs/nvidia_fit_native_add3_20250426_200613/tto_test_report/nvidia_render_metrics.xlsx'
...
def calculate_metrics(data_dir, sequence, methods, lpips_loss):
    ...
    for time in range(time_start, time_end):  # Fix view v0, change time
        ...
        for method_idx, method in enumerate(methods):
            ...
            SSIM = structural_similarity(img_true, img, channel_axis=-1, data_range=255)
...
if __name__ == "__main__":
    ...
    # )
    eval_nvidia_dir(
        gt_dir="./eval_utils/nvidia_rodynrf_gt/Balloon1",
        pred_dir="./data/nvidia/Balloon1/logs/nvidia_fit_native_add3_20250426_200613/tto_test",
        report_dir="./data/nvidia/Balloon1/logs/nvidia_fit_native_add3_20250426_200613/tto_test_report",
    )
    print('ok')
