...
def get_metric3dv2_model(device, version="giant2"):
    ...
    # model = torch.hub.load("/home/xuankai/.cache/torch/hub/Metric3D-main", f"metric3d_vit_{version}", pretrain=False, \
    #                     source='local', model_path='/home/xuankai/.cache/torch/hub/checkpoints/metric_depth_vit_giant2_800k.pth')
    # model = torch.hub.load("/home/xuankai/.cache/torch/hub/Metric3D-main", f"metric3d_vit_small", pretrain=False, \
    #                     source='local', model_path='/home/xuankai/.cache/torch/hub/checkpoints/metric_depth_vit_small_800k.pth')
    model.to(device)
    model.eval()
    return model
